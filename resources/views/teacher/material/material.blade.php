                                            ...
                                            @foreach ($material as $showmaterial)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{route('teacher.material.destroy', Crypt::encrypt($showmaterial->id))}}" method="post" class="d-inline">
                                                            @csrf
                                                            @method('delete')
    ...
    <script>
        $(document).ready(function(){
            $('#tambahmateri').on('click', function () {
                ...
                $('.body_materi form').attr('action', '{{route("teacher.material.store")}}');
            ...
            $('#editmateri*').on('click', function () {
                ...
                let _url = '{{route("teacher.material.edit",":id")}}'.replace(':id', id);

                $('.body_materi button[type=submit]').text('Edit');
                $('.modal-title').text('Edit Materi');
                $('.body_materi form').attr('action', '{{route("teacher.material.update",":id")}}'.replace(':id', id));
                $('.body_materi form').attr('method', 'post');
