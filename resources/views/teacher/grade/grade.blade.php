    ...
    <script>
        $(document).ready(function(){
            $('#tambahnilai').on('click', function () {
                ...
                $('.body_nilai form').attr('action', '{{route("teacher.grade.store")}}');
            ...
            $('#editnilai*').on('click', function () {
                ...
                let _url = '{{route("teacher.grade.edit",":id")}}'.replace(':id', id);

                $('.body_nilai button[type=submit]').text('Edit');
                $('.modal-title').text('Edit Nilai');
                $('.body_nilai form').attr('action', '{{route("teacher.grade.update",":id")}}'.replace(':id', id));
                $('.body_nilai form').attr('method', 'post');
