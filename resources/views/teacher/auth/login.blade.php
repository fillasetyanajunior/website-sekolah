...
@section('content')
    <div class="limiter">
		<div class="container-login100" style="background-image: url({{url('assets/auth/images/img-01.jpg')}});">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form" action="{{route('teacher.login.post')}}" method="POST">
                    @csrf
					<div class="login100-form-avatar">
						<img src="{{url('assets/auth/images/avatar-01.png')}}">
					</div>
