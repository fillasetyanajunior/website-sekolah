                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($offensestudent as $showoffensestudent)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-warning" id="editpelanggaran" data-bs-toggle="modal" data-bs-target="#PelanggaranModal" data-id="{{$detail->id}}">Ubah</button>
                                                    <form action="{{route('counseling.offense.destroy', $detail->id)}}" method="post" class="d-inline">
                                                        @csrf
                                                        @method('delete')
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" id="pelaportguru">
                                <div class="mb-3">
                            ...
                            <div class="col-lg-6" id="pelaportother">
                                <div class="mb-3">
                                    <label for="pelapor" class="form-label">Pelapor</label>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="pembinaan">
                                <option value="">-- Pilih --</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="keterangan">
                                <option value="">-- Pilih --</option>
                                <option value="1">Pantauan</option>
                            </select>
                        </div>
                    </div>
            ...
            $('#editpelanggaran*').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (hasil) {
                        ...
                        var keterangan = null;
                        if (hasil.keterangan == 'Pemantauan') {
                            keterangan = 1;
                        }
