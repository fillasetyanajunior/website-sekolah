            ...
            <ul class="navbar-nav pt-lg-3">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item" href="{{route('admin.subject')}}">
                                    Mata Pelajaran
                                </a>
                                <a class="dropdown-item" href="{{route('admin.year')}}">
                                    Tahun Pelajaran
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{route('admin.teacher')}}">
                                    Management Guru
                                </a>
                                <a class="dropdown-item" href="{{route('admin.student')}}">
                                    Management Siswa
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{route('admin.registration')}}">
                                    Data Pendaftaran
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{route('admin.grade')}}">
                                    Nilai Akademik
                                </a>
                                <a class="dropdown-item" href="{{route('admin.extracurricular')}}">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item" href="{{route('admin.achievement')}}">
                                    Prestasi
                                </a>
    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    aria-label="Open user menu">
                    <span class="avatar avatar-sm" style="background-image: url({{url('assets/dashboard/dist/img/default.png')}})"></span>
                    <div class="d-none d-xl-block ps-2">
                        <div>{{Auth::user()->name}}</div>
                    </div>
                </a>
