    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                @if (Auth::user()->role != 'Kepala Tata Usaha' || Auth::user()->role != 'Tata Usaha' || Auth::user()->role != 'Bendahara' || Auth::user()->role != 'Tenaga Keamanan' || Auth::user()->role != 'Petugas Kebersihan' || Auth::user()->role != 'Operator Data' || Auth::user()->role != 'Lainnya')
                    <li class="nav-item">
