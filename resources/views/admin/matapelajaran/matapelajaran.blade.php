                                ...
                                <table class="table table-striped table-hover table-borderless">
                                    ...
                                    <tbody>
                                        @php
                                            $i = 1;
                                        @endphp
                                        @foreach ($matapelajaran as $showmatapelajaran)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$showmatapelajaran->matapelajaran}}</td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                                            <a class="dropdown-item" href="" id="editmatapelajaran" data-toggle="modal" data-target="#matapelajaranModal" data-id="{{$showmatapelajaran->id}}">Edit</a>
                                                            <form action="{{route('admin.subject.destroy', $showmatapelajaran->id)}}" method="post" >
                                                                @csrf
                                                                @method('delete')
