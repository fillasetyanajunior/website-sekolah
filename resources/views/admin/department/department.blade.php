                        ...
                        <div class="col-12 col-md-auto ms-auto d-print-none">
                            <div class="btn-list">
                                <a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal"
                                    data-bs-target="#JurusanModal" id="tambahjurusan">
                                ...
                                <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal"
                                    data-bs-target="#JurusanModal" id="tambahjurusan" aria-label="Tambah Jususan">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    ...
                                    <table class="table card-table table-vcenter text-nowrap datatable">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($department as $showdepartment)
                                                <tr>
                                                    <td>{{$i++}}</td>
                                                    <td>{{$showdepartment->jurusan}}</td>
                                                    <td width="100px">
                                                        <button type="button" class="btn btn-sm btn-warning" id="editjurusan" data-bs-toggle="modal" data-bs-target="#JurusanModal" data-id="{{Crypt::encrypt($showdepartment->id)}}">Ubah</button>
                                                        <form action="{{route('admin.department.destroy', Crypt::encrypt($showdepartment->id))}}" method="post" class="d-inline">
                                                            @csrf
                                                            @method('delete')
...
<div class="modal modal-blur fade" id="JurusanModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#editjurusan*').click(function () {
                ...
                $('.body_jurusan button[type=submit]').text('Edit');
